...
class   DateTime  {
    ...
    public:
       ...
       //
        void set_timezone (TIME_ZONE tz)  {
        ...
        TIME_ZONE get_timezone () const  { return (time_zone_); }

        typedef unsigned int        DateType;
        typedef unsigned short int  DatePartType;
        typedef unsigned short int  HourType;         // 3,600 / 1
        typedef unsigned short int  MinuteType;       // 60 / 1
        typedef unsigned short int  SecondType;       // 1 / 1
        typedef short int           MillisecondType;  // 1 / 1,000
        typedef int                 MicrosecondType;  // 1 / 1,000,000
        typedef unsigned int        NanosecondType;   // 1 / 1,000,000,000
        typedef time_t              EpochType;
    ...
    public:
        ...
        void set_time (EpochType the_time,
                       MillisecondType millis = 0) noexcept;
    ...
    public:
       ...
       // search and replace.
       //
        inline double diff_business_days (const DateTime &that)
            const noexcept  {
        ...
        inline bool is_newyear () const noexcept  {
           ...
           // December 31)
           //
            return (((m_day == 1 || (w_day == MON && m_day == 2)) &&
                      mon == JAN) ||
       ...
       //
        ...
        template<class cu_STRING>
        inline void date_to_str (unsigned int format, cu_STRING &result) const;
...
date_to_str (unsigned int format, cu_STRING &result) const  {
