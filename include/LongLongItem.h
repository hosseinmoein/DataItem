...
class   LongLongItem : public NumericItem  {

    public:

        typedef long long int   value_type;

        inline LongLongItem () : val_ (0)  {   }
        inline explicit LongLongItem (value_type i) : val_ (i)  {   }
        inline LongLongItem (const LongLongItem &r)
            : NumericItem (r), val_ (r.val_)  {   }
        inline LongLongItem (LongLongItem &&r)
            : NumericItem (r), val_ (r.val_)  {   }
        inline ~LongLongItem ()  {   }

        inline LongLongItem &operator = (const LongLongItem &rh)  {
       ...
       // override class DataItem virtual functions
        ...
        inline const char *name_of () const  { return ("LongLongItem"); }
        inline types type_api () const  { return (longlongType); }

    protected:

        inline DataItem *_clone_hook () const  {

            return (new LongLongItem (*this));
        }
...
inline std::ostream &operator << (std::ostream &o, const LongLongItem &r)  {
...
inline bool
operator == (const LongLongItem &lhs, const LongLongItem &rhs) throw ()  {
